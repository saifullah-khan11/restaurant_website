...
📜 Menu Page: Displays dishes with categories, prices, and images.  
📅 Reservations: Simple and intuitive table booking form.  
📍 Contact Page: Integrated Google Maps, contact details, and social links.  
📱 Responsive Design: Works perfectly on desktops, tablets, and smartphones.  
🌙 Optional Dark Mode: Toggle between light and dark themes.  
